  ...
  return (
    <nav className="flex flex-wrap justify-between items-center z-10 relative">
      ...
      <button
        ...
        className="dark:text-gray-400 dark:hover:bg-gray-700 btn-press-anim p-2 focus:ring-2 focus:ring-gray-200 rounded-lg hover:bg-gray-100 lg:hidden"
      >
      ...
      >
        <ul className="flex flex-col lg:flex-row bg-gray-50 text-lg border border-gray-100 rounded-lg p-4 lg:bg-transparent lg:border-none lg:space-x-8 lg:dark:text-white">
          {ROUTES.map((route, i) => {
            return (
              <li
                key={route}
